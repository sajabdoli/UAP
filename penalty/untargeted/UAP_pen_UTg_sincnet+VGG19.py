...
from misc import energy_np, energy_tensor, create_wave_batch_u
from UAP_pen_Untarg import un_pert_gen
...
if __name__ == '__main__':
    ...
    # Batch size
    len_batch= 70
    # No. of available training samples
    ...
    print ("attacking untarget:")

    v, fooling_rate = un_pert_gen(len_train_set_att, len_batch, X_train_arced, X_train_att, Y_train_att, model_end,
    ...
    str1="universal-pen-UNTARGETED-sincnet+VGG19.best.npy"
    np.save(str1, v)
